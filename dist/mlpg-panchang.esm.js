...
var MlpgLocalConstant = function MlpgLocalConstant() {
  ...
  this.Nakshatra = {
    name: ['അശ്വതി', 'ഭരണി', 'കാർത്തിക', 'രോഹിണി', 'മകം', 'തിരുവാതിര', 'പുനർതം', 'പൂയം', 'ആയില്യം', 'മകം', 'പൂരം', 'ഉത്രം', 'അത്തം', 'ചിത്തിര', 'ചോതി', 'വിശാഖം', 'അനിഴം', 'ത്രികേട്ട്', 'മൂലം', 'പൂരാടം', 'ഉത്രാടം', 'തിരുവോണം', 'അവിട്ടം', 'ചതയം', 'പൂരുരുട്ടാതി', 'ഉത്രറ്റാതി', 'രേവതി'],
  ...
  this.Tithi = {
    name: ['പ്രതിപത്യം', 'ദ്വിതീയ', 'തൃതീയ', 'ചതുര്‍ത്ഥി', 'പഞ്ചമി', 'ഷഷ്ഠി', 'സപ്തമി', 'അഷ്ടമി', 'നവമി', 'ദശമി', 'ఏകാദശി', 'ദ്വാദശി', 'ത്രയോദശി', 'ചതുര്ദശി', 'പൗര്‍ണമി', 'പ്രതിപത്യം', 'ദ്വിതീയ', 'തൃതീയ', 'ചതുര്‍ത്ഥി', 'പഞ്ചമി', 'ഷഷ്ഠി', 'സപ്തമി', 'അഷ്ടമി', 'നവമി', 'ദശമി', 'ഏകാദശി', 'ദ്വാദശി', 'ത്രയോദശി', 'ചതുര്ദശി', 'അമാവാസ്യ']
  ...
  this.Karna = {
    ...
    name: ['ബവ', 'ബാലവ', 'കൗളവ', 'തൈതില', 'കര', 'വാണിജ്യ', 'വിഷ്ടി', 'ശകുനി', 'ചതുർപ്പദ', 'നാഗ', 'കിംസ്തുഘ്ന']
  };
  this.Yoga = {
    ...
    name: ['വിഷ്‌കുംബം', 'പ്രീതി', 'ആയുഷ്മാന്‍', 'സൗഭാഗ്യം', 'ശോഭന', 'അതിര്‍ഘണ്ടം', 'സുകര്‍മ്മാ', 'ധൃതി', 'ശൂലം', 'ഘണ്ടം', 'വൃദ്ധി', 'ധ്രുവം', 'ব্যാഘാത്', 'ഹര്‍ഷണം', 'വജ്രം', 'അശുക്', 'വ്യതിപാതം', 'വരിയാന്‍', 'പരിഘം', 'ശിവം', 'സിദ്ധം', 'സാധ്യം', 'ശുഭം', 'ശുക്ലം', 'ബ്രഹ്മ', 'ഇന്ദ്ര', 'വൈധൃതി']
  };
  this.Trinity = {
...
export { MlpgPanchang };
//# sourceMappingURL=mlpg-panchang.esm.js.map
